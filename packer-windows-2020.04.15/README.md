...
```
It also was necessary for me to invoke PowerShell from within PowerShell with -Command attribute as so: 

powershell -Command "& {Mount-DiskImage -ImagePath" "C:\Users\phillip.hocking\Workspace\2019-base-dev\packer-windows-2020.04.15\iso\Server_2019_Datacenter_1909.ISO" "-Verbose}"
```
